...
def generate_wordlist_from_profile(profile):
    ...
    #adding custom character "-" forgotten
    kombi[21] = list(komb(kombinaa, bdss))
    kombi[21] += list(komb(kombinaa, bdss, "-"))
    kombi[22] = list(komb(kombinaaw, wbdss))
    kombi[22] += list(komb(kombinaaw, wbdss, "-"))
    kombi[23] = list(komb(kombinaak, kbdss))
    kombi[23] += list(komb(kombinaak, kbdss, "-"))
    kombi[24] = list(komb(kombinaa, years))
    kombi[24] += list(komb(kombinaa, years, "-"))
    kombi[25] = list(komb(kombinaac, years))
    kombi[25] += list(komb(kombinaac, years, "-"))
    kombi[26] = list(komb(kombinaaw, years))
    kombi[26] += list(komb(kombinaaw, years, "-"))
    kombi[27] = list(komb(kombinaak, years))
    kombi[27] += list(komb(kombinaak, years, "-"))
    kombi[28] = list(komb(word, bdss))
    kombi[28] += list(komb(word, bdss, "-"))
    kombi[29] = list(komb(word, wbdss))
    kombi[29] += list(komb(word, wbdss, "-"))
    kombi[30] = list(komb(word, kbdss))
    kombi[30] += list(komb(word, kbdss, "-"))
    kombi[31] = list(komb(word, years))
    kombi[31] += list(komb(word, years, "-"))

    kombi[32] = list(komb(reverse, years))
    kombi[32] += list(komb(reverse, years, "-"))
    kombi[33] = list(komb(rev_w, wbdss))
    kombi[33] += list(komb(rev_w, wbdss, "-"))
    kombi[34] = list(komb(rev_k, kbdss))
    kombi[34] += list(komb(rev_k, kbdss, "-"))
    kombi[35] = list(komb(rev_n, bdss))
    kombi[35] += list(komb(rev_n, bdss, "-"))
